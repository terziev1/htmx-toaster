...
```html
<script defer src="https://unpkg.com/htmx-toaster@0.0.5/dist/htmx-toaster.min.js"></script>
```

IE11 Compatible version

```html
<script defer src="https://unpkg.com/htmx-toaster@0.0.5/dist/htmx-toaster.ie11.min.js"></script>
```
